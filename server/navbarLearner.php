        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse col-4 mx-5 mt-1" id="main-nav">
                ...
                <ul class="navbar-nav d-flex flex-row me-1">
                    ...
                    <div class="col-4 ms-4 justify-content-right">
                        <li class="nav-item ">
                    ...
                    <div class="col-4">
                        <div class="collapse navbar-collapse ms-3 justify-content-right" id="navbar-list-5">
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                ...
                                <img class="rounded-circle shadow-1-strong me-3"
                                    src="<?php echo $_SESSION['picture']; ?>" alt="avatar" width="65" height="65" />
                            </ul>
                        </div>
                    </div>
                </ul>
